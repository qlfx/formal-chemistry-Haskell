...
evaluate reactionInput@(ReactionInput_Metal_Acid metal acid) = evaluateMetalAcid (reactionOccurs reactionInput) metal acid
evaluate reactionInput@(ReactionInput_Metal_Salt metal salt) = evaluateMetalSalt (reactionOccurs reactionInput) metal salt
